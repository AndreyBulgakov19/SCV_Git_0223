...
6. Проверка связи локального и удаленного репозитория

Необходимо выполнить комнаду в командной строке:
```
git remote
```
...
После выполнения команды git push из локального репозитория необходимо:
- Перейти в удаленный репозиторий
- На вкладке "<> Code" убедиться что появилось уведомление и кнопка "Compare & pull request"
- Нажать на кнопку "Compare & pull request"
- Убедиться что слияние возможно (Able to merge)
- Добавть описание коммита
- Нажать на кнопку "Create pull request"

Если на вкладке "<> Code" не появилось уведомление и кнопка "Compare & pull request" отсутствует то pull request можно выполнить самостоятельно вручную:
- Перейти в удаленный репозиторий
- Перейти на вкладку "Pull requests"
- Нажать на кнопку "New pull request"
- Выбрать направления откуда и куда будут вноситься изменения
- Убедиться что слияние возможно (Able to merge)
- Нажать на кнопку "Create pull request"
