...
```
><sup>*Для того, чтобы не писать полностью имя файла, достаточно ввести первые три-четыре символа, а затем нажать клавишу __TAB__*</sub>
...
><sup>*Удалённый репозиторий - это репозиторий, который находится не на локальной, а на удалённой машине, например, на сервере.*</sub>

![Logo GitHub](GitHub.jpg)

GitHub - сервис компании Майкрософт для организации работы удаленных репозиториев, самый популяярный сервис Git, у него много полезных функций и огромный архив различного кода.

Для начала работы с удалёнными репозиториями необходимо создать аккаунт на GitHub.com https://github.com/

![GitHub sign up](sign_up.jpg)

### 13.1 Клонирование внешнего репозитория на свой ПК можно командой:
```
git clone <url-адрес репозитория в сети>
```
Копируем url-адрес удаленного репозитория:

![Clon repository](clon.jpg)

Команда `git clone` составная: она не только загружает все изменения, но и пытается слить все ветки на локальном компьютере и в удаленном репозитории.

### 13.2 Скачивание из текущего репозитория и автоматическое *merge*

Команда, позволяющая скачать все из текущего репозитория и автоматически сделать *merge* с нашей версией:
```
git pull
```
### 13.3 Отправка своей версии во внешний репозиторий.

Команда, позволяющая отправить свою версию репозитория во внешний репозиторий:
```
git push
```
При первом использовании **нужна авторизация** на внешнем репозитории.

### 13.4 Схема настройки совместной работы

#### 1. Создать аккаунт на GitHub.com
#### 2. Создать локальный репозиторий
#### 3. Связать между собой локальный и удалённый репозиторий
><sup>*GitHub при создании нового репозитория подскажет, как это можно сделать*</sub>

![New repository](new_repository.jpg)
![New repository 2](get_along.jpg)
...
В больших компаниях один ответственный за проект создает аккаунт. Другие пользователи дают команду pull request. Проедлагать изменения на GitHub нужно в отдельной ветке. Сначала пользователь копирует репозиторий на свой компьютер, делает *folk* репозитория:

![folk](folk.jpg)

затем клонирует версию на своем ПК, создает ветку с предлагаемыми изменениями, отправляет командой *push* в свой аккаунт на GitHub и дает команду *pull request*.

![Pull request](pull_request.jpg)
